"""
Tuning XGBoost hyperparameters using hyperopt. I referenced this Kaggle kernel:
https://www.kaggle.com/yassinealouini/predicting-red-hat-business-value/hyperopt-the-xgboost-model
